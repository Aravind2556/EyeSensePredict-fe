...
//             Normal Range
//           </th>
//           <th className="text-right px-3 py-2 text-gray-600 font-semibold">
//             Value
//           </th>
//         </tr>
//       </thead>
...
//       <tbody>
//         {labels.map((label, i) => {
//           const value = predictData?.latest_values?.[i];
//           const range = NORMAL_RANGES[label];
...
//                     0,
//                     ((value - range.min) /
//                       ((range.max === Infinity ? range.min * 2 : range.max) -
//                         range.min)) *
//                       100
//                   )
//                 )
...
//                 ${!normal ? "bg-red-50" : "hover:bg-gray-50"}
//               `}
//             >
...
//                       normal ? "bg-green-500" : "bg-red-500"
//                     }`}
//                     style={{ width: `${percent}%` }}
//                   />
//                 </div>
...
//                   normal ? "text-green-700" : "text-red-700"
//                 }`}
//               >
